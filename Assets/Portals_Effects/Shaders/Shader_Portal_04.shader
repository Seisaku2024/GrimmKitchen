...
Shader "Shader_Portal_04"
{
	Properties
	{
		...
		_Mask_Out("Mask_Out", Float) = 1
		_Speed_01("Speed_01", Vector) = (-0.1,-0.1,0,0)
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				OUT.ase_texcoord1 = IN.ase_texcoord2;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 texCoord255 = IN.ase_texcoord1;
				texCoord255.xy = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 texCoord252 = IN.ase_texcoord2;
				texCoord252.xy = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner195 = ( 1.0 * _Time.y * ( _Speed_01 * texCoord252.x ) + ( texCoord197 * 4.0 ));
				...
				float4 appendResult53 = (float4(( IN.color * texCoord255.y ).rgb , saturate( ( pow( ( tex2DNode193.r * tex2DNode194.r ) , texCoord252.z ) - ( 1.0 - ( pow( ( ( 1.0 - temp_output_218_0 ) - temp_output_228_0 ) , texCoord255.w ) * pow( ( temp_output_218_0 - temp_output_228_0 ) , _Mask_Out ) ) ) ) )));
...
Node;AmplifyShaderEditor.Vector2Node;232;544,320;Inherit;False;Property;_Speed_01;Speed_01;6;0;Create;True;0;0;0;False;0;False;-0.1,-0.1;-0.2,-0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;252;384,496;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;253;736,432;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;194;1104,272;Inherit;True;Property;_Noise01;Noise01;1;0;Create;True;0;0;0;False;0;False;-1;190a07dc9f11e924ebfd8a5dbd4f8666;190a07dc9f11e924ebfd8a5dbd4f8666;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.Vector2Node;233;1424,192;Inherit;False;Property;_Speed_02;Speed_02;7;0;Create;True;0;0;0;False;0;False;0.1,0;0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;255;1248,864;Inherit;False;2;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;216;1824,848;Inherit;False;Property;_Mask_Out;Mask_Out;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;196;1696,96;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.1,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;193;1920,96;Inherit;True;Property;_Texture02;Texture 02;0;0;Create;True;0;0;0;False;0;False;-1;None;190a07dc9f11e924ebfd8a5dbd4f8666;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;220;2304,624;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;246;2226,256;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;222;1840,624;Inherit;False;Property;_Mask_In;Mask_In;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;208;2384,176;Inherit;False;Property;_Step;Step;4;0;Create;True;0;0;0;False;0;False;0.08;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;249;2755.045,195.0791;Inherit;False;Property;_Emissive;Emissive;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;115;3360,272;Float;False;True;-1;2;ASEMaterialInspector;0;10;Shader_Portal_04;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;True;4;1;False;;1;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;0;;0;0;Standard;0;0;1;True;False;;False;0
WireConnection;209;0;197;0
WireConnection;209;1;210;0
WireConnection;253;0;232;0
WireConnection;253;1;252;1
WireConnection;195;0;209;0
WireConnection;195;2;253;0
...
WireConnection;239;1;255;4
WireConnection;240;0;227;0
WireConnection;240;1;216;0
...
ASEEND*/
//CHKSM=947BE21197B2E0B6D3EA5853E7FF2B4F2662ACD5