...
public class HanselStageStateUpdate_PortalTutrial : BaseHanselStageStateUpdate
{
    [Header("ウィンドウコントローラー")]
    [SerializeField]
    ...
    private async UniTask CreateWindow()
    {
        ...
        try
        {
            ...
            // チュートリアル完了を記憶
            StoryProgressManager.instance.GetStoryProgressData(StoryProgressType.FirstVisitLobbyScene).SetFinish();
            StoryProgressManager.instance.GetStoryProgressData(StoryProgressType.CompleteHanselGretelTutrial).SetFinish();
