...
public class HanselStageStateUpdate_MoveTutrial : BaseHanselStageStateUpdate
{
    ...
    [Header("会話State変更")]
    [SerializeField]
    private TalkingFase m_talkingFase = TalkingFase.Fase1;
    ...
    override public async UniTask OnExit()
    {
        ...
        if (m_npcCore)
        {
            m_npcCore.m_animator.SetTrigger("IsMove");
            m_npcCore.NPCParameters.MoveTargetPositionFlg = true;
            m_npcCore.NPCParameters.StageState = m_nextHanselStageState;
        }
