...
Shader "Toon/TFF_CustomBush"
{
	Properties
	{
		...
		_GrassColor("Grass Color", Color) = (1,1,1,1) //ADDED
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				// RGBを指定した色に変更
				tex2DNode134.rgb = float3(_GrassColor.r, _GrassColor.g, _GrassColor.b);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode134 = tex2D( _TextureSample, uv_TextureSample );
				tex2DNode134.rgb = float3(_GrassColor.r, _GrassColor.g, _GrassColor.b);//ADDED
