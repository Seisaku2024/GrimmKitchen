...
Shader "Toon/TFF_CustomToonAlphaDitherVegetation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.positionNDC=positionCS.xyz/positionCS.w;
				 ...
				 ) : SV_Target
			{
				...
				// float2 localuv = fmod( IN.positionCS, _CellSize) / _GradationMap_TexelSize.zw;
				...
				// float3 sample = tex2D( _TextureSample, uv_TextureSample).rgb;
				...
				_CameraDistDither_f3ea153662e641e9bdd4f5afae705947.WorldSpacePosition = IN.positionWS;
				_CameraDistDither_f3ea153662e641e9bdd4f5afae705947.NDCPosition = IN.positionCS.xyz/IN.positionCS.w;
				...
				//追加
				Alpha =_CameraDistDither_f3ea153662e641e9bdd4f5afae705947_OutVector1_1_Float * tex2DNode134.a;
				//
				...
				Alpha =(AlphaClipThreshold<Alpha)? 1:0;
				#endif
    ...
    //             float2 uv_BayerTex = ( screenPos.xy / screenPos.w ) * ( _ScreenParams.xy / _BlockSize );
