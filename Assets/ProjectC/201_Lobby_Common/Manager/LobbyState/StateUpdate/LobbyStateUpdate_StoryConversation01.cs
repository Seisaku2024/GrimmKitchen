...
public class LobbyStateUpdate_StoryConversation01 : BaseLobbyStateUpdate
{
    [Header("ウィンドウコントローラー")]
    [SerializeField]
    ...
    public override async UniTask OnInitialize()
    {
        ...
        try
        {
            var Trasition = CutSceneManager.instance?.TransitionController;
            // カットシーンマネージャー存在したら
            if (Trasition)
            {
                Trasition.ImageAlphaUpdate(1.0f);
            }
