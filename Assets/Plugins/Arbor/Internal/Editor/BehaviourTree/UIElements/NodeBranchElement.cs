...
namespace ArborEditor.BehaviourTree.UIElements
{
	...
	internal sealed class NodeBranchElement : VisualElement
	{
		...
		public Bezier2D bezier => _Bezier;
		...
		public void Update(NodeBranch branch)
		{
			...
			_BezierElement.startPosition = _Bezier.startPosition;
			_BezierElement.startControl = _Bezier.startControl;
			_BezierElement.endPosition = _Bezier.endPosition;
			_BezierElement.endControl = _Bezier.endControl;
