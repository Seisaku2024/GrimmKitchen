...
namespace ArborEditor.UIElements
{
	internal sealed class PanManipulator : DragManipulator
	{
		...
		private static bool IsSupportedHorizontalScroll()
		{
			if (Application.platform == RuntimePlatform.OSXEditor)
				return true;

			var version = InternalEditorUtility.GetUnityVersion();
			return version.Major >= 6 && version.Major < 2017
				|| version.Major > 2023
				|| version.Major == 2023 && version.Minor >= 2
				|| version.Major == 2021 && version.Minor == 3 && version.Build >= 30
				|| version.Major == 2022 && version.Minor == 3 && version.Build >= 6
				|| version.Major == 2023 && version.Minor == 1 && version.Build >= 10;
		}
		...
		private void OnScroll(WheelEvent e)
		{
			...
			if (!IsSupportedHorizontalScroll() && e.shiftKey)
			{
				// swap x <- -> y
