...
namespace Arbor
{
	...
	public sealed class RectParameterReference : ParameterReferenceBase<Rect>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override Rect GetValue(Parameter parameter)
		{
...
#endif
		protected override Rect GetDefault()
		{
			return new Rect();
		}
...
#endif
		protected override void SetValue(Parameter parameter, Rect value)
		{
