...
namespace Arbor
{
	...
	public sealed class StringParameterReference : ParameterReferenceBase<string>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override string GetValue(Parameter parameter)
		{
...
#endif
		protected override void SetValue(Parameter parameter, string value)
		{
