...
namespace Arbor
{
	...
	public sealed class BoundsIntParameterReference : ParameterReferenceBase<BoundsInt>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override BoundsInt GetValue(Parameter parameter)
		{
...
#endif
		protected override BoundsInt GetDefault()
		{
...
#endif
		protected override void SetValue(Parameter parameter, BoundsInt value)
		{
