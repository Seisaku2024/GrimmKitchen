...
namespace Arbor
{
	...
	public sealed class RectIntParameterReference : ParameterReferenceBase<RectInt>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override RectInt GetValue(Parameter parameter)
		{
...
#endif
		protected override void SetValue(Parameter parameter, RectInt value)
		{
