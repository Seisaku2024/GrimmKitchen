...
namespace Arbor
{
	...
	public sealed class ComponentParameterReference : ParameterReferenceBase<Component>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override Component GetValue(Parameter parameter)
		{
...
#endif
		protected override void SetValue(Parameter parameter, Component value)
		{
