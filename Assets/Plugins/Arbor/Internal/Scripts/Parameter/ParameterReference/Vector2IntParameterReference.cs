...
namespace Arbor
{
	...
	public sealed class Vector2IntParameterReference : ParameterReferenceBase<Vector2Int>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override Vector2Int GetValue(Parameter parameter)
		{
...
#endif
		protected override void SetValue(Parameter parameter, Vector2Int value)
		{
