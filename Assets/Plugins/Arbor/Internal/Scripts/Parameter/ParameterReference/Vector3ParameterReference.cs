...
namespace Arbor
{
	...
	public sealed class Vector3ParameterReference : ParameterReferenceBase<Vector3>
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Parameterから値を取得する。
...
#endif
		protected override Vector3 GetValue(Parameter parameter)
		{
...
#endif
		protected override Vector3 GetDefault()
		{
			return Vector2.zero;
		}
...
#endif
		protected override void SetValue(Parameter parameter, Vector3 value)
		{
