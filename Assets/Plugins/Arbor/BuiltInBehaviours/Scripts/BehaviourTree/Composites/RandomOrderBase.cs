...
{
	public abstract class RandomOrderBase : SequencerBase
	{
		...
		protected override int GetBeginIndex()
		{
		...
		protected override int GetNextIndex(int index)
		{
			_OrderIndex++;
		...
		protected override int GetInterruptIndex(TreeNodeBase node)
		{
			_ChildNodeOrders.Clear();
